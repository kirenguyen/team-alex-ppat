...
def onButton(channel):
    if channel == 16:
        os.system("/home/pi/team-alex-ppat/camerafeed.sh")
    if channel == 10:
        os.system("/home/pi/team-alex-ppat/stopcamerafeed.sh")
...
GPIO.add_event_detect(10, GPIO.FALLING, callback=onButton, bouncetime=20)
